...
<nav>
	<ul class="pagination">
		<li <c:if test="${!page.hasPreviouse}">class="disabled"</c:if>><a
			href="?page.start=0${page.param}&puzzle.puzzleId=${puzzle.puzzleId}" aria-label="Previous"> <span
				aria-hidden="true">&laquo;</span>
		</a></li>

		<li <c:if test="${!page.hasPreviouse}">class="disabled"</c:if>><a
			href="?page.start=${page.start-page.count}${page.param}&puzzle.puzzleId=${puzzle.puzzleId}"
		...
		<c:forEach begin="0" end="${page.totalPage-1}" varStatus="status">
			...
			<c:if
				...
				<li
					...
					<a href="?page.start=${status.index*page.count}${page.param}&puzzle.puzzleId=${puzzle.puzzleId}"
		...
		<li <c:if test="${!page.hasNext}">class="disabled"</c:if>><a
			href="?page.start=${page.last}${page.param}&puzzle.puzzleId=${puzzle.puzzleId}" aria-label="Next"> <span
