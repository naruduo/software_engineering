	...
	<div class="container-fluid">
		<div class="row">
				...
				<tbody>
					<c:forEach items="${exps}" var="exp">
						<tr class="success">
							...
							<td class="text-center"><a class="btn btn-primary"
								href="<%=request.getContextPath()%>/exp/deleteExp.action?exp.expId=${exp.expId}&exp.expName=${exp.expName}"
			...
			<div class="text-center">
				<a
					href="<%=request.getContextPath()%>/teacher/teacher_experienceEditor.jsp"><span
					class="glyphicon glyphicon-plus"></span>新建一个实验</a>
