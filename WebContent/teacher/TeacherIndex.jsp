									...
									<div class="col-xs-9 wthree_banner_bottom_grid_right">
										...
										<div class="agileits-button two service">
											<a class="btn btn-primary btn-lg hvr-underline-from-left"
												href="teacher/teacher_listMyStudents.action" role="button">GO
												! »</a>
										</div>
									</div>
							...
							<div class="agileinfo_banner_bottom_pos">
								<div class="w3_agileits_banner_bottom_pos_grid two">
									...
									<div class="col-xs-9 wthree_banner_bottom_grid_right">
										...
										<div class="agileits-button two service">
											<a class="btn btn-primary btn-lg hvr-underline-from-left"
												href="teacher/teacher_addStudent.jsp" role="button">GO ！
												»</a>
										</div>
									</div>
									<div class="clearfix"></div>
							...
							<div class="agileinfo_banner_bottom_pos">
								<div class="w3_agileits_banner_bottom_pos_grid two">
									...
									<div class="col-xs-9 wthree_banner_bottom_grid_right">
										...
										<div class="agileits-button two service">
											<a class="btn btn-primary btn-lg hvr-underline-from-left"
												href="<%=request.getContextPath()%>/test/newNotification.jsp"
												role="button">GO ！ »</a>
										</div>
									</div>
									<div class="clearfix"></div>
							...
							<div class="agileinfo_banner_bottom_pos">
								<div class="w3_agileits_banner_bottom_pos_grid two">
									...
									<div class="col-xs-9 wthree_banner_bottom_grid_right">
										...
										<div class="agileits-button two service">
											<a class="btn btn-primary btn-lg hvr-underline-from-left"
												href="teacher/upload.jsp" role="button">GO ！ »</a>
										</div>
									</div>
									<div class="clearfix"></div>
								</div>
							...
							<div class="agileinfo_banner_bottom_pos">
								<div class="w3_agileits_banner_bottom_pos_grid two">
									...
									<div class="col-xs-9 wthree_banner_bottom_grid_right">
										...
										<div class="agileits-button two service">
											<a class="btn btn-primary btn-lg hvr-underline-from-left"
												href="teacher/teacher_uploadCommonFile.jsp" role="button">GO
												！ »</a>
										</div>
									</div>
									<div class="clearfix"></div>
