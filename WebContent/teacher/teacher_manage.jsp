		...
		<div class="top-container">
            ...
            <div class="container">
                ...
                <div class="large-logo">
                    <a href="#"><img src="../img/teacher_logo.jpg" alt="logo"   width="100" height="100"/></a>
                </div>
                
               <div class="vticker" style="position: relative; height: 62px; overflow: hidden;">
                    <ul style="margin: 0px; position: absolute; top: 0px;">                                                                 
                      <li style="margin: 0px; display: list-item;">WE ARE APEX</li>
                      <li style="margin: 0px; display: list-item;">INVENT THE FUTURE</li>
